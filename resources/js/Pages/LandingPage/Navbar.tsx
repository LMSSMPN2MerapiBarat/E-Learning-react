...
<<<<<<< HEAD
    ...
    return (
        <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white shadow-md py-3' : 'bg-transparent py-5'}`}>
            {/* ^^^^ PY-3 (sebelumnya PY-2) ^^^^ */}  {/* ^^^^ PY-5 (sebelumnya PY-4) ^^^^ */}
          ...
          <div className="hidden md:flex items-center space-x-8">
            <div className="flex items-center space-x-1">
              {navLinks.map((link) => (
                <a
                  ...
                  className={`relative px-3 py-2 text-sm font-bold transition-all group ${
            ...
            <Link
              ...
              className={`px-6 py-2 rounded-full text-sm font-bold transition-all shadow-sm ${
                scrolled ? 'bg-blue-600 text-white hover:bg-blue-700' : 'bg-white text-blue-900 hover:bg-blue-50'
              }`}
            >
