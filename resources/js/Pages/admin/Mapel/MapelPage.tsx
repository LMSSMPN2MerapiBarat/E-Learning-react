    ...
    <AdminLayout>
      ...
      {isBulkDeleting && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="flex flex-col items-center space-y-2 rounded-xl bg-white p-4 shadow-lg animate-fade-in">
            <Loader2 className="h-8 w-8 animate-spin text-blue-600" />
            <p className="font-medium text-gray-700 text-sm">Menghapus data mapel...</p>
          </div>
        </div>
      )}
